...
​
## 📌 Conclusiones
Evaluación de impacto y beneficios de Salesforce en ConstruFurgo, incluyendo métricas de eficiencia.
...
Para la entrega de este proyecto se deben tener los siguientes puntos en cuenta:

La documentación creada deberá ser subida en un repositorio privado de GitHub compartido con el Trainer con el nombre “Proyecto_Salesforce_ApellidoNombre”, el cual contendrá los (README) solicitados al inicio de este proyecto. Su desarrollo quedará a criterio propio del desarrollador.